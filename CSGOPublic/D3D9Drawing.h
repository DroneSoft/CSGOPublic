//Drawing class - I believe made by Strife and heavily edited by me.
#pragma once
...
public:
	...
	virtual void Begin()
	{
		...
		if (!pFont)
		{
			if (D3DXCreateFont(pDevice, 13, 0, FW_NORMAL, 1, FALSE, DEFAULT_CHARSET, OUT_DEFAULT_PRECIS, DEFAULT_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Verdana", &pFont) != D3D_OK) return;
		}
